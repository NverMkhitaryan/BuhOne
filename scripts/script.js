...
const imgList = ['client.png', 'client.png', 'client.png', 'client.png', 'client.png'];
let clientsIndex = 0;
...
const scrollElem = document.querySelector('#scrollTop');
const bodyElem = document.querySelector('body');

scrollElem.addEventListener('click', ()=>{
	bodyElem.scrollIntoView({behavior: 'smooth'});
});
